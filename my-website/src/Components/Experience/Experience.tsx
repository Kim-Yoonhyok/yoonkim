            ...
            <div className="experience">
                ...
                <div className="exp">
                    <div className="expContainer">
                        ...
                        <h2 className="company"><a href="https://vitashop.ca/en/" target="_blank">VitaShop</a></h2>
                        <h3 className="location">Toronto, ON</h3>
                        <h4 className="role">Digital Marketing / Frontend Developer</h4>
                        <div className="description">
                ...
                <div className="exp">
                    <div className="expContainer">
                        ...
                        <h2 className="company"><a href="https://aquaculturegrowsns.ca/" target="_blank">Cooke Aquaculture</a></h2>
                        <h3 className="location">Saint John, NB</h3>
                        <h4 className="role">Software Developer Intern</h4>
                        <div className="description">
